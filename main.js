...
async function sendFromWallet(walletInfo, maxTransaction) {
  ...
  for (let i = 1; i <= maxTransaction; i++) {
    ...
    let amountHex;
    try {
      amountHex = ethers.hexZeroPad(ethers.toHexString(amountInUnits), 32).slice(2); // Convert to 32-byte hex
    } catch (err) {
    ...
    const operand = '' +
      ...
      addressHex +
      '' +
      amountHex;
